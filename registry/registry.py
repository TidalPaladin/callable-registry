...
class RegisteredFunction(Generic[P, T]):
    ...
    def cast(self: Self, typ: Type[Callable[P_cast, T_cast]]) -> "RegisteredFunction[P_cast, T_cast]":
        return self  # type: ignore

    def bind(self: Self, **kwargs) -> Self:
        return replace(self, fn=bind_relevant_kwargs(self.fn, **kwargs))

    def bind_metadata(self: Self, **kwargs) -> Self:
        kwargs = {**self.metadata, **kwargs}
